...
1. Create HID Gadget Setup Script
...
6. Create UDEV Rule for Persistent Permissions
...
2. Set Index.php as Default Page

To make index.php load automatically when someone visits your IP address, you may need to modify the Apache directory index:
...
firstpi@raspberrypi:~ $ cat /etc/apache2/mods-enabled/dir.conf
<IfModule mod_dir.c>
...
After reboot, check if everything is working:
